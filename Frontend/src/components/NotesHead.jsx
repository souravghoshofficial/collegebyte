  ...
  return (
    ...
    <div className='w-[80%] mx-auto flex flex-col gap-2 items-center pt-16 pb-8 px-3 lg:py-8'>
        <div className='py-2 mb-1 lg:mb-2'>
            <h1 className='text-white text-2xl lg:text-4xl md:text-2xl font-bold'>Notes</h1>
        </div>
        <div className='w-full lg:w-[50%] md:w-[50%] flex items-center'>
            <input type="text" placeholder={`Search for ${placeholder} notes`} className='h-9 py-2 px-4 rounded-l w-full bg-transparent text-white border border-slate-300 shadow-sm focus:outline-none focus:border-sky-500'/>
