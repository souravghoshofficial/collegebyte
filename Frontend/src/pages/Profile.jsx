    ...
    <div className="min-h-screen lg:w-[85%] lg:ml-[15%] md:w-[85%] md:ml-[15%]">
      <div className='w-full flex flex-col items-center justify-center'>
        <div className='bg-white/5 backdrop-blur-md border-t border-white/20 shadow shadow-gray-400 mx-auto flex gap-4 items-center mt-24 px-6 py-4 text-white rounded-lg'>
              <div>
                <img src={profileImg} alt="Profile Pic" className='w-24 h-24 rounded-full border-4 border-transparent ring-2 ring-[#27E0B3]' />
              </div>
              <div>
                <div className='mt-1'>
                  <h2 className='text-2xl font-bold tracking-wide'>Sourav Ghosh</h2>
                </div>
                <div>
                  <h4 className='text-lg font-thin italic'>sourav@gmail.com</h4>
                </div>
